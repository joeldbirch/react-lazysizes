...
var _reactComponentWrapper = (0, _reactTransformHmr3['default'])({
  filename: '/home/matikku/projects/react-lazysizes/src/LazySizes.js',
...
var LazySizes = (function (_React$Component) {
  ...
  function LazySizes() {
    ...
    _classCallCheck(this, _LazySizes);

    _get(Object.getPrototypeOf(_LazySizes.prototype), 'constructor', this).apply(this, arguments);
  ...
  var _LazySizes = LazySizes;
  LazySizes = _wrapComponent('_$LazySizes')(LazySizes) || LazySizes;
  return LazySizes;
